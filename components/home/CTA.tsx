    ...
    <section className="bg-[url('/bg/cta.png')]">
      <div className="w-full max-w-6xl mx-auto p-7">
        <div className="text-background w-full md:w-[80%] lg:w-[70%] my-20">
          <h2 className="text-2xl md:text-4xl font-medium leading-snug">Join the Newton Academy Tech Revolution Today!</h2>
          <p className="my-5 text-sm md:text-base">
            ...
            switch careers, Newton Academy is here for you! We can't wait to
            start this journey with you. Apply now and let the adventure begin!
          </p>
