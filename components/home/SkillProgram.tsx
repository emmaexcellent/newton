...
const SkillProgram = () => {
  return (
    <section className="w-full mt-0 bg-[#F8F8F8] py-10 pt-20 md:pt-40">
      <div className="relative w-full max-w-6xl mx-auto px-7 overflow-hidden">
        ...
        <Image
          ...
          alt="design box dot"
          priority
          className="absolute w-32 md:h-40 top-24 opacity-60 -left-12"
        />
        <div className="flex items-start md:items-center justify-between flex-col md:flex-row gap-5">
          <div className="w-full md:w-[500px] lg:w-[750px]">
            <h2 className="text-2xl md:text-4xl leading-snug lg:text-5xl font-medium pb-5 lg:leading-snug">
              <span className="text-gradient">Skill Enhancement </span>
              <br /> Programs (SKEP)
            </h2>
            <p className="text-sm md:text-base text-foreground/70">
              For tech professionals: Short bite courses to upskill you to
              becoming the best, find answers to your tech questions, get
              mentored by global tech leaders, get certified and get promoted.
            </p>
          </div>
